                            ...
                            <table class="table table-bordered table-sm">
                                ...
                                @forelse ($sellers as $index => $seller)
                                    <tr>
                                        ...
                                        @if($seller->currentSubscriptionPlan())
                                            <td>{{ $seller->currentSubscriptionPlan()->plan_data ? $seller->currentSubscriptionPlan()->plan_data['name'] . ' ($' . $seller->currentSubscriptionPlan()->plan_data['cost'] . ')' : '-' }}</td>
                                        @else
                                            <td> - </td>
                                        @endif
                                        <td>
