            ...
            <div class="division-of-cards division-method-rs">
                <div class="div-cards-prnt">
                    ...
                    <div class="div-cards div-cards-red">
                        ...
                        <a href="{{ route('buyer.pages.pricingPlan') }}" class="pick-a-plan pap-abs change-plan">Change Plan</a>
                    </div>
                </div>
                            ...
                            <div class="card-type-section">
                                @if (Session::has('success'))
                                    <div class="alert alert-success text-center">
                                        ...
                                        <p><a href="{{ route('buyer.pages.home') }}">Go back to Homepage</a></p>
                                    </div>
                                @endif
                                ...
                                <div class="payment-select-prnt">
                                    ...
                                    <div class="card-credentials w-100">
                                        <form
                                            style="width: 100%"
                                            role="form"
                                            action="{{ route('buyer.subscription.create', ['plan' => $plan->id]) }}"
                                            method="post"
