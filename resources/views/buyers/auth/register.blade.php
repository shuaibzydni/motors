    ...
    <div class="login_wrapper forgot-wrap w-100 flt">
        <div class="login-margin-auto-part">
            ...
            <div class="switch-part">
                <a class="login-sw swich-sec" href="{{ route('buyer.login') }}">Login</a>
                <a class="new-user-sw swich-sec active" href="{{ route('buyer.register') }}">New User</a>
            </div>
            <div class="login-section">
                <p>Create your account</p>
                <form class="login-form" method="POST" action="{{ route('buyer.register.post') }}">
                    @csrf
