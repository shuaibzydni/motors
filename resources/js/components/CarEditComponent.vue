<template>
  ...
  >
      ...
      <div class="flex-container">
        ...
        <div class="inner_flx">
          ...
          <div class="flx_list">
            ...
            <a
              v-if="payload.service_log_book"
              :href="payload.service_log_book"
              target="_blank"
              >View</a
            >
          ...
          <div class="flx_list">
            ...
            <img
              v-if="typeof payload.front_image === 'string'"
              :src="payload.front_image"
              alt="Front Image"
              style="width: 200px"
            />
          ...
          <div class="flx_list">
            ...
            <img
              v-if="typeof payload.rear_image === 'string'"
              :src="payload.rear_image"
              alt="Rear Image"
              style="width: 200px"
            />
          ...
          <div class="flx_list">
            ...
            <img
              v-if="typeof payload.left_side_image === 'string'"
              :src="payload.left_side_image"
              alt="Left Side Image"
              style="width: 200px"
            />
          ...
          <div class="flx_list">
            ...
            <img
              v-if="typeof payload.interior_image === 'string'"
              :src="payload.interior_image"
              alt="Interior Image"
              style="width: 200px"
            />
          ...
          <div class="flx_list">
            ...
            <img
              v-if="typeof payload.cargo_area_image === 'string'"
              :src="payload.cargo_area_image"
              alt="Cargo Area Image"
              style="width: 200px"
            />
          ...
          <div class="flx_list">
            ...
            <img
              v-if="typeof payload.engine_bay_image === 'string'"
              :src="payload.engine_bay_image"
              alt="Engine Image"
              style="width: 200px"
            />
          ...
          <div class="flx_list">
            ...
            <img
              v-if="typeof payload.roof_image === 'string'"
              :src="payload.roof_image"
              alt="Roof Image"
              style="width: 200px"
            />
          ...
          <div class="flx_list">
            ...
            <img
              v-if="typeof payload.wheels_image === 'string'"
              :src="payload.wheels_image"
              alt="Wheels Image"
              style="width: 200px"
            />
          ...
          <div class="flx_list">
            ...
            <img
              v-if="typeof payload.keys_image === 'string'"
              :src="payload.keys_image"
              alt="Keys Image"
              style="width: 200px"
            />
          ...
          <div class="flx_list">
            ...
            <a
              v-if="payload.owners_manual"
              :href="payload.owners_manual"
              target="_blank"
              >View</a
            >
    ...
    <div class="popup_footer">
      <button type="submit" class="sell_btn btn">Save</button>
...
export default {
  ...
  async created() {
    ...
    await this.getCarDetail(this.carId);
    if (this.carData) {
      await this.getModels({ brand_id: this.carData.product_brand_id })

      this.payload = {
        product_brand_id: this.carData.product_brand_id,
        product_make_id: this.carData.product_make_id,
        body_type_id: this.carData.body_type_id,
        drive_type_id: this.carData.drive_type_id,
        fuel_type_id: this.carData.fuel_type_id,
        transmission_id: this.carData.transmission_id,
        model_year: this.carData.model_year,
        name: this.carData.name,
        model_description: this.carData.model_description,
        odometer_mileage: this.carData.odometer_mileage,
        vehicle_registration_number: this.carData.vehicle_registration_number,
        vehicle_vin: this.carData.vehicle_vin,
        vehicle_price: this.carData.vehicle_price,
        vehicle_status: this.carData.vehicle_status,
        service_log_book: this.carData.service_log_book,
        front_image: this.carData.front_image,
        rear_image: this.carData.rear_image,
        left_side_image: this.carData.left_side_image,
        interior_image: this.carData.interior_image,
        cargo_area_image: this.carData.cargo_area_image,
        engine_bay_image: this.carData.engine_bay_image,
        roof_image: this.carData.roof_image,
        wheels_image: this.carData.wheels_image,
        keys_image: this.carData.keys_image,
        owners_manual: this.carData.owners_manual,
      };
    }
  },
  methods: {
    ...
    async submitForm(payload) {
      ...
      for (let key in payload) {
        if (
          key === "service_log_book" ||
          key === "front_image" ||
          key === "rear_image" ||
          key === "left_side_image" ||
          key === "interior_image" ||
          key === "cargo_area_image" ||
          key === "engine_bay_image" ||
          key === "roof_image" ||
          key === "wheels_image" ||
          key === "keys_image" ||
          key === "owners_manual"
        ...
        let loader = this.$loading.show()
      await CarApi.carUpdate(this.carId, formData)
        .then((response) => {
            loader.hide();
